...
const Login = () => {
  ...
  return (
      ...
      <form className='absolute w-3/12 p-12 bg-black my-36 mx-auto right-0 left-0 text-white rounded-lg bg-opacity-80'>
        ...
        {!isSignInForm && <input type="text" placeholder="Full Name" className= "p-4 my-4 w-full bg-zinc-600" />}
        <input type="text" placeholder="Email Address" className= "p-4 my-4 w-full bg-zinc-600" />  
        <input type="password" placeholder="Password" className= "p-4 my-4 w-full bg-zinc-600" />
